...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub PopulateTestGroups()
		  ...
		  TestCountLabel.Text = Str(mController.GroupCount) + "個のグループで" + Str(testCount) + "個のテスト。"
	...
	#tag Method, Flags = &h21
		Private Sub RunTests()
		  ...
		  TestCountLabel.Text = Str(mController.GroupCount) + "個のグループで" + Str(testCount) + "個のテストが実行されました。"
...
#tag Events TestGroupList
	...
	#tag Event
		Sub Change()
		  ...
		  If Me.RowTag(row) IsA TestResult Then
		    ...
		    TestDurationLabel.Text = Format(tr.Duration, "#,###.0000000")
		  End If
		End Sub
	#tag EndEvent
	#tag Event
	...
	#tag Event
		Function ConstructContextualMenu(base as MenuItem, x as Integer, y as Integer) As Boolean
		  base.Append(New MenuItem("全てを選択"))
		  base.Append(New MenuItem("選択の反転"))
		  base.Append(New MenuItem("全てを選択解除"))
